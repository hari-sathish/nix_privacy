...
<form name="form1" method="POST" action="datat.php" onsubmit="return check();">
  <div class="container bg-light">
    <div class="container">
    <div class="row d-flex justify-content-center">
    
      <div class="col-md-3">
        <input type="text" name="owner" class="form-control" placeholder="Data Owner">

      </div>
        <div class="col-md-3">
        <input type="text" name="process" class="form-control" placeholder="Process">
...
<select name="identify[]" multiple="multiple" class="selectpicker" multiple data-live-search="true">
   ...
   <div id="collapse-pane-2" class="collapse" role="tabpanel" aria-labelledby="accord2" data-parent="#demo-accordion-collapse">
          <div class="card-body">
             <div class="container">
              ...
              <div class="col-md-4 ">
       <select name="ethinicity[]" class="selectpicker" multiple="multiple" multiple data-live-search="true">
  ...
  <div id="collapse-pane-3" class="collapse" role="tabpanel" aria-labelledby="accord3" data-parent="#demo-accordion-collapse">
          <div class="card-body">
             <div class="container-fluid">
              ...
              <div class="col-md-4">
        <select class="selectpicker" name="sexual[]" multiple="multiple" multiple data-live-search="true">
...
or activity, on-line or off </h3>
              <div class="col-md-4 ">
      <select name="behavioral[]" multiple="multiple" class="selectpicker" multiple data-live-search="true">
...
an individual’s characteristics shared with others</h3>
              <div class="col-md-4 ">
                   <select class="selectpicker" name="demographics[]" multiple="multiple" multiple data-live-search="true">
...
medical conditions or health care</h3>
              <div class="col-md-4 ">
<select class="selectpicker" name="medical[]" multiple="multiple" multiple data-live-search="true">
   ...
   <div id="collapse-pane-7" class="collapse" role="tabpanel" aria-labelledby="accord7" data-parent="#demo-accordion-collapse">
          <div class="card-body">
             <div class="container">
              ...
              <div class="col-md-4 ">
          <select class="selectpicker" name="physical[]" multiple="multiple" multiple data-live-search="true">
...
if(isset($_POST['submit']))  
{
  ...
  $identifying=$_POST['identify'];
  $a=implode(",",$identifying);
  $ethinicity=$_POST['ethinicity'];
  $b=implode(",",$ethinicity);
  $sexual=$_POST['sexual'];
  $c=implode(",",$sexual);
  $behavioral=$_POST['behavioral'];
  $d=implode(",",$behavioral);
  $demographics=$_POST['demographics'];
  $e=implode(",",$demographics);
  $medical=$_POST['medical'];
  $f=implode(",",$medical);
  $physical=$_POST['physical'];
  $g=implode(",",$physical);

  $sql= "INSERT INTO nix(owner, process, identify, ethinicity, sexual, behavioral, demographics, medical, physical ) VALUES ('$name', '$process', '$a', '$b', '$c', '$d', '$e', '$f', '$g')";
  if(mysqli_query($conn,$sql))
  {

        echo "<script>alert('Go to Internal Data')</script>";  

        echo "<script>window.open('Internal.php','_self')</script>";    }  
