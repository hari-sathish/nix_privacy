...
<div class="col-md-4 ">
<select name="professional[]" multiple="multiple" class="selectpicker" multiple data-live-search="true">
   ...
   <div id="collapse-pane-2" class="collapse" role="tabpanel" aria-labelledby="accord2" data-parent="#demo-accordion-collapse">
          <div class="card-body">
             <div class="container">
              ...
              <div class="col-md-4 ">
<select name="criminal[]" class="selectpicker" multiple="multiple" multiple data-live-search="true">
  ...
  <div id="collapse-pane-3" class="collapse" role="tabpanel" aria-labelledby="accord3" data-parent="#demo-accordion-collapse">
          <div class="card-body">
             <div class="container-fluid">
              ...
              <div class="col-md-4">
          <select name="public[]" class="selectpicker" multiple="multiple" multiple data-live-search="true">
   ...
   <div id="collapse-pane-4" class="collapse" role="tabpanel" aria-labelledby="accord4" data-parent="#demo-accordion-collapse">
          <div class="card-body">
             <div class="container">
              ...
              <div class="col-md-4 ">
        <select name="family[]" multiple="multiple" class="selectpicker" multiple data-live-search="true">
   ...
   <div id="collapse-pane-5" class="collapse" role="tabpanel" aria-labelledby="accord5" data-parent="#demo-accordion-collapse">
          <div class="card-body">
             <div class="container">
              ...
              <div class="col-md-4 ">
       <select name="social[]" multiple="multiple" class="selectpicker" multiple data-live-search="true">
...
if(isset($_POST['submit']))  
{
  ...
  $j=implode(",",$communication);

  $sql= "INSERT INTO social(professional , criminal, public, family, social, communication) VALUES ('$e', '$f', '$g', '$h', '$i', '$j')";
