function sum()
{
	...
	var per1=(add*100)/12;
document.write("Controller sum is :"+ " " + per1 +"%"+"<br>");
...
var num=0;
 ...
 var per2=(num*100)/5;
	document.write("Joint_controller sum is :"+""+ per2+"%" +"<br>");
	...
	var per3=(mix*100)/10;
document.write("processor sum is :"+" "+per3 +"%" +"<br>");

if(per1>75)
{
	 if((per2>50 && per2<75) && per3<50)
	{
...
if ((per1<50) && ((per2>50) && (per2<75)) && (per3<50))
{
	alert("Look like you are joint controller");
}
if((per1>50 && per1<75) && per2<50 && per3<50)
{
	alert("Look like you are a controller");
}
if((per1>75 && per3>75) || ((per1>75) && (per3>50 && per3<75)) || ((per1>50 && per1<75) && (per3>75)))
{
