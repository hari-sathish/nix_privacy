...
<div class="col-md-4 ">
          <select name="account[]" multiple="multiple" class="selectpicker" multiple data-live-search="true">
   ...
   <div id="collapse-pane-2" class="collapse" role="tabpanel" aria-labelledby="accord2" data-parent="#demo-accordion-collapse">
          <div class="card-body">
             <div class="container">
              ...
              <div class="col-md-4 ">
          <select name="ownership[]" class="selectpicker" multiple="multiple" multiple data-live-search="true">
  ...
  <div id="collapse-pane-3" class="collapse" role="tabpanel" aria-labelledby="accord3" data-parent="#demo-accordion-collapse">
          <div class="card-body">
             <div class="container-fluid">
              ...
              <div class="col-md-4">
          <select class="selectpicker" name="transactional[]" multiple="multiple" multiple data-live-search="true">
   ...
   <div id="collapse-pane-4" class="collapse" role="tabpanel" aria-labelledby="accord4" data-parent="#demo-accordion-collapse">
          <div class="card-body">
             <div class="container">
              ...
              <div class="col-md-4 ">
          <select class="selectpicker" name="credit[]" multiple="multiple" multiple data-live-search="true">
...
if(isset($_POST['submit']))  
{
  ...
  $g=implode(",",$transactional);
  $credit=$_POST['credit'];
  $h=implode(",",$credit);

  $sql= "INSERT INTO financial(account , ownership, transactional, credit) VALUES ('$e', '$f', '$g', '$h')";
  if(mysqli_query($conn,$sql))
  {

        echo "<script>alert('Go to Social Data')</script>";  
