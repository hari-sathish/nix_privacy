...
<div class="col-md-4 ">
  <select class="selectpicker" name="life[]" multiple="multiple" multiple data-live-search="true">
   <option value="events that happened in a person's life, either to them or just around them which might have influenced them (WWII, 9/11)">events that happened in a person’s life, either to them or just around them which might have influenced them (WWII, 9/11)</option>
 </select>  
</div>
     </div>
      </div>
...
if(isset($_POST['submit']))  
{
  ...
  $sql= "INSERT INTO historical(life) VALUES ('$g')";
  if(mysqli_query($conn,$sql))
  {

        echo "<script>alert('Go to Financial Data')</script>";  

        echo "<script>window.open('financial.php','_self')</script>";    }  
